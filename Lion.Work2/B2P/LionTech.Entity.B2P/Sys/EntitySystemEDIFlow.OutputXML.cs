    ...
    public class EntitySystemEDIFlowOutputXML : EntitySys
    {
        ...
        public List<Entity_BaseAP.SystemEDIJobDetail> SysEDIJobList(SystemEDIXMLPara para)
        {
            string commandText = string.Concat(new object[]
            {
                ...
                "     , IS_USE_RES,FILE_SOURCE,FILE_ENCODING, URL_PATH,IS_DISABLE,SORT_ORDER ", Environment.NewLine,
        ...
        public List<Entity_BaseAP.SystemEDIFlowDetail> SysEDIFlowList(SystemEDIXMLPara para)
        {
            string commandText = string.Concat(new object[]
            {
                ...
                "     , {EDI_FLOW} AS EDI_FLOW_NM,SCH_START_TIME ", Environment.NewLine,
                "     , SCH_DATA_DELAY,PATHS_CMD,PATHS_DAT,PATHS_SRC,PATHS_RES ", Environment.NewLine,
