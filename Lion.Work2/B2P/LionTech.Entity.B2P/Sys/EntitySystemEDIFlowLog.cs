    ...
    public class EntitySystemEDIFlowLog : EntitySys
    {
        ...
        public class SystemEDIFlowLogPara : DBCulture
        {
            ...
            public enum ParaField
            {
                ...
                DATA_DATE, STATUS_ID, IS_AUTOMATIC, IS_DELETED, UPD_USER_ID, CULTURE_ID
            }
        ...
        public class SystemEDIFlowLog : DBTableRow
        {
            public enum DataField
            {
                ...
                STATUS_ID, RESULT_ID, RESULT_CODE,EDIFLOW_STATUS_NM,EDIFolw_RESULT_NM,
        ...
        public List<SystemEDIFlowLog> SelectSystemEDIFlowLogList(SystemEDIFlowLogPara para)
        {
            ...
            {
                commandWhere = string.Concat(new object[] { commandWhere, "  AND (F.EDI_DATE={EDI_DATE} OR F.EDI_DATE IS NULL) ", Environment.NewLine });
            }
            if (!string.IsNullOrWhiteSpace(para.EDIFlowID.GetValue())) 
            {
            ...
            string commandText = string.Concat(new object[]
            {
                ...
                "     , (CASE WHEN F.RESULT_ID IS NULL THEN NULL ELSE dbo.FN_GET_NMID(F.RESULT_ID, dbo.FN_GET_CM_NM('0003', F.RESULT_ID, {CULTURE_ID})) END) AS EDIFolw_RESULT_NM ", Environment.NewLine,
                ...
                "JOIN SYS_SYSTEM_EDI_FLOW E ON F.SYS_ID=E.SYS_ID AND F.EDI_FLOW_ID=E.EDI_FLOW_ID ", Environment.NewLine,
            ...
            if (dataTable.Rows.Count > 0)
            {
                ...
                foreach (DataRow dataRow in dataTable.Rows)
                {
                    SystemEDIFlowLog systemEDIFlowLog = new SystemEDIFlowLog()
                    {
                        ...
                        EDIFlowResultNM = new DBNVarChar(dataRow[SystemEDIFlowLog.DataField.EDIFolw_RESULT_NM.ToString()]),
