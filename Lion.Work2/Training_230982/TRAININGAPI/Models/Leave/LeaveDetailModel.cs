        ...
        public bool EditLeaveData(Prapsppm96 leaveModel)
        {
            try
            {
                var para = new EntityLeaveDetail.LeaveDetailPara
                {
                    ...
                    ppm96_begin = new DBChar(leaveModel.ppm96_begin),
                    ppm96_end = new DBChar(leaveModel.ppm96_end),
                    ppm95_id = new DBVarChar(leaveModel.ppm95_id),
                    ppd95_id = new DBVarChar(leaveModel.ppd95_id),
                    pm96_sign = new DBVarChar(leaveModel.ppm96_sign),
                };
        ...
        public Prapsppm96 GetLeaveData()
        {
            ...
            if (leaveData != null)
            {
                return new Prapsppm96
                {
                    ...
                    ppm96_begin = leaveData.ppm96_begin.GetValue().ToString("yyyy/MM/dd HH:mm"),
                    ppm96_end = leaveData.ppm96_end.GetValue().ToString("yyyy/MM/dd HH:mm"),
