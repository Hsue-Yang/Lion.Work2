    ...
    public class EntitySystemEDICon : EntitySys
    {
        ...
        public List<SystemEDICon> SelectSystemEDIConList(SystemEDIConPara para)
        {
            ...
            string commandText = string.Concat(new object[]
            {
                ...
                "     , C.SORT_ORDER, dbo.FN_GET_USER_NM(C.UPD_USER_ID) AS UPD_USER_NM, C.UPD_DT ", Environment.NewLine,
                "FROM SYS_SYSTEM_EDI_CON C ", Environment.NewLine,
                "INNER JOIN SYS_SYSTEM_EDI_FLOW E ON C.EDI_FLOW_ID=E.EDI_FLOW_ID AND E.SYS_ID=C.SYS_ID", Environment.NewLine,
            ...
            if (dataTable.Rows.Count > 0)
            {
                ...
                {
                    SystemEDICon ediConnect = new SystemEDICon()
                    {
                    ...
                    systemEDIConList.Add(ediConnect);
                }
