...
namespace LionTech.Entity.ERP.Sys
{
    public class EntitySystemEDIJob : EntitySys
    {
        ...
        public class SystemEDIJobPara : DBCulture
        {
            ...
            {
                SYS_ID, SYS_NM,
                EDI_FLOW_ID, EDI_FLOW,
                EDI_JOB, EDI_JOB_TYPE, UPD_USER_ID,
                CULTURE_ID
            }
        ...
        public class SystemEDIJob : DBTableRow
        {
            public enum DataField
            {
                ...
                EDI_JOB_ID, EDI_JOB_NM, EDI_JOB_TYPE, OBJECT_NAME, DEP_EDI_JOB_ID, IS_USE_RES, IGNORE_WARNING, IS_DISABLE,
        ...
        public List<SystemEDIJob> SelectSystemEDIJobList(SystemEDIJobPara para)
        {
            ...
            if (para.EDIFlowID != null && !string.IsNullOrWhiteSpace(para.EDIFlowID.GetValue()))
            {
                ...
                {
                    commandWhere, "  AND E.EDI_FLOW_ID={EDI_FLOW_ID} ", Environment.NewLine
                });
            }

            if(!string.IsNullOrWhiteSpace(para.EDIJobType.GetValue()))
            {
                commandWhere = string.Concat(new object[]
                {
                    commandWhere, "  AND J.EDI_JOB_TYPE={EDI_JOB_TYPE} ", Environment.NewLine
                });
            }
            ...
            string commandText = string.Concat(new object[]
            {
                ...
                "     , dbo.FN_GET_NMID(J.EDI_JOB_TYPE, dbo.FN_GET_CM_NM('0006', J.EDI_JOB_TYPE, {CULTURE_ID})) AS EDI_JOB_TYPE ", Environment.NewLine,
                "     , J.OBJECT_NAME, J.DEP_EDI_JOB_ID, J.IS_USE_RES, J.IGNORE_WARNING, J.IS_DISABLE ", Environment.NewLine,
            ...
            dbParameters.Add(new DBParameter { Name = SystemEDIJobPara.ParaField.EDI_JOB_TYPE.ToString(), Value = para.EDIJobType });
            dbParameters.Add(new DBParameter { Name = SystemEDIJobPara.ParaField.CULTURE_ID.ToString(), Value = new DBVarChar(para.CultureID) });
            ...
            if (dataTable.Rows.Count > 0)
            {
                ...
                foreach (DataRow dataRow in dataTable.Rows)
                {
                    SystemEDIJob systemEDIJob = new SystemEDIJob()
                    {
                        ...
                        EDIJobType = new DBNVarChar(dataRow[SystemEDIJob.DataField.EDI_JOB_TYPE.ToString()]),
                        ...
                        IgnoreWarning = new DBChar(dataRow[SystemEDIJob.DataField.IGNORE_WARNING.ToString()]),
