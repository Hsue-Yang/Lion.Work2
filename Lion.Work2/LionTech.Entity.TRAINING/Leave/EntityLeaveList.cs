    ...
    public class EntityLeaveList : EntityLeave
    {
        ...
        public List<Leave> SelectLeaveList()
        {
            string commandText = string.Concat(new object[]
            {
              ...
              "       ,m96.ppm96_sign " +
              "FROM prapsppm96 m96 " +
              "INNER JOIN prapsppd95 d95 ON d95.ppd95_id=m96.ppd95_id " +
              "INNER JOIN prapsppm95 m95 ON m95.ppm95_id = d95.ppm95_id"
            });
            ...
            if (dataTable.Rows.Count > 0)
            {
                ...
                foreach (DataRow dataRow in dataTable.Rows)
                {
                    Leave leave = new Leave()
                    {
                        ...
                        pm96_sign = new DBInt(dataRow[Leave.DataField.ppm96_sign.ToString()]),
                    };
                    leaveList.Add(leave);
        ...
        public List<Ppd95> SelectPpdList()
        {
            string commandText = string.Concat(new object[]
            {
               "SELECT  ppd95_id"+
